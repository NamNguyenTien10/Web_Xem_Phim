                ...
                <tbody>
                  <c:forEach items="${video}" var="vid">
	                  <tr>
	                  	...
	                  	<td><a href="<c:url value='/video?action=watch&id=${vid.href}'/>">${vid.href}</a></td>
	                  	<td><img src="${vid.poster}" width="150px" height="150px"></td>
	                  	<td><a href="<c:url value='/admin/video/view-edit?id=${vid.id}'/>" class="btn btn-primary">Edit</a> 
						<a href="<c:url value='/admin/video/delete?id=${vid.id}'/>" class="btn btn-success">Delete</a> </td>
	                  </tr>
                  </c:forEach> 
                </tbody>
              </table>
