	...
	<!-- Preloader -->
		...
		<nav
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item d-none d-sm-inline-block"><a href="<c:url value='/admin'/>"
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
				...
				<div class="user-panel mt-3 pb-3 mb-3 d-flex">
					...
					<div class="info">
						<a style="font-size: 25px; margin-top: 10px" href="#" class="d-block">${sessionScope.currentUser.username}</a>
					</div>
				</div>
               ...
               with font-awesome or any other icon font library -->
						<li class="nav-item"><a href="<c:url value='/admin'/>" class="nav-link active">
						...
						<li class="nav-item menu-open"><a href="" class="nav-link">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item"><a
									href="<c:url value='/admin/user/view'/>" class="nav-link">
						...
						<li class="nav-item menu-open"><a href="#" class="nav-link">
							...
							<ul class="nav nav-treeview">
								 <%-- <li class="nav-item"><a
									href="<c:url value='/admin/favorite'/>" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
										<p>Video Favorite</p>
								</a></li>  --%>
								<li class="nav-item"><a
									href="<c:url value='/admin/video/view'/>" class="nav-link">
										<i class="far fa-circle nav-icon"></i>
										<p>List Video</p>
								</a></li>
								
								<li class="nav-item"><a href="<c:url value='/admin/video/view-add'/>"
