	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<form action="/Web_Xem_Phim/admin/video/add" method="post">
					<div class="mb-3">
						<label for="formGroupExampleInput" class="form-label">Title</label> 
						<input type="text" class="form-control"
							id="formGroupExampleInput" name="title"
							>
					</div>
					<div class="mb-3">
						<label for="formGroupExampleInput2" class="form-label">Href</label> 
						<input type="text" class="form-control"
							id="formGroupExampleInput2" name="href">
					</div>
					<div class="mb-3">
						<div class="row">
							<div class="col-lg-9">
					...
					<div class="mb-3">
						<div class="row">
							...
							<div style="margin-top: -320px; margin-bottom: 200px">
								...
								<input type="text" class="form-control" id="formGroupExampleInput2" name="poster">	
							</div>						
							</div>
						</div>
					</div>
